...
<html>
	...
	<nav style="background-color: dimgrey" class="fh5co-nav" role="navigation">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid">
                            <img style="width: 360px; height:360px;" src="{{asset('storage/'.$products->image)}}" alt="">
							{{-- <div class="inner">
								<p>
						...
						<div class="desc">
							<h3><a href="single.html">{{ $products->discribtion }}</a></h3>
...
{{--	<div id="fh5co-started">
	...
	<!-- Waypoints -->
	<script src="    {{ asset('assets/js/jquery.waypoints.min.js') }}
    "></script>
	<!-- Carousel -->
